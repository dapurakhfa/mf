...
import { Button, Quote } from '@dakhfa/design-system'
...
export default function Home(): React.ReactNode {
  return (
    <Page>
      ...
      <Text variant="h2" className="mt-10 mb-6">
        packages/dakhfa-components
      </Text>
      <Text className="mb-4">
        Works in the same way as <Code>packages/dakhfa-design-system</Code> but
      ...
      <Text variant="h2" className="mt-10 my-6">
        packages/dakhfa-storybook
      </Text>
      <Text className="mb-4">
        This packages takes the stories in{' '}
        <Code>packages/dakhfa-design-system</Code> and opens them in{' '}
